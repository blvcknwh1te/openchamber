...
| `OPENCHAMBER_GITLAB_CLIENT_ID` | OAuth application ID used for GitLab device flow. Personal access token and `glab` authentication remain available without it. |
