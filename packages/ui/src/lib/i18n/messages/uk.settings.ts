...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  'settings.sourceControl.reset.title': 'Скинути налаштування керування кодом',
  'settings.sourceControl.reset.description': 'Видалити всі збережені посилання керування кодом для цього репозиторію.',
  'settings.sourceControl.reset.action': 'Скинути керування кодом',
  'settings.sourceControl.reset.confirmTitle': 'Скинути налаштування керування кодом?',
  'settings.sourceControl.reset.confirmDescription': 'Буде видалено всі збережені посилання на провайдерів, транспорт і допоміжні ресурси для цього репозиторію. Облікові дані, віддалені репозиторії та конфігурація Git, робоче дерево й ідентичність автора не зміняться.',
  'settings.sourceControl.reset.failed': 'Налаштування керування кодом змінилися або їх не вдалося скинути. Перевірте оновлені налаштування перед повторною спробою.',
  'settings.sourceControl.reset.confirmAction': 'Скинути налаштування',
