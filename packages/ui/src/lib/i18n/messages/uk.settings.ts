...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.customCss.section": "Власний CSS",
  "settings.openchamber.customCss.sectionInfo": "CSS рівня користувача, який середовище VS Code додає до кожної панелі після теми.",
  "settings.openchamber.customCss.field.label": "Файл CSS",
  "settings.openchamber.customCss.field.infoWithPath": "Зміни застосовуються одразу. Файл: {path}",
  "settings.openchamber.customCss.field.info": "Зміни застосовуються одразу. Файл лежить у теці налаштувань OpenChamber.",
  "settings.openchamber.customCss.actions.open": "Відкрити / створити",
  "settings.openchamber.customCss.actions.reset": "Скинути до типових",
  "settings.openchamber.customCss.resetDone": "custom.css скинуто до типового шаблону",
  "settings.openchamber.customCss.failed": "Не вдалося оновити custom.css",
  ...
  "settings.openchamber.visual.field.unifiedSlashEntitiesAria": "Показувати команди та скіли в одному списку",
  "settings.openchamber.visual.field.unifiedSlashEntities": "Об’єднані слеш-команди та скіли",
  "settings.openchamber.visual.field.unifiedSlashEntitiesInfo": "Показує /команди та /скіли в одному списку й передає агенту шлях до їхнього файлу, щоб він бачив, на що ви посилаєтеся поруч із текстом. Вимкнено: попередня поведінка.",
