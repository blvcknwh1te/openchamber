...
export const dict = {
  ...
  'sessions.sidebar.session.tooltip.model': 'Modèle : {model}',
  'sessions.sidebar.session.tooltip.cost': 'Coût : {cost}',
  'sessions.sidebar.session.tooltip.tokens': 'Jetons : {tokens}',
  ...
  'chat.compaction.tooltip.automatic': 'Compaction lancée automatiquement',
  'chat.compaction.tooltip.manual': 'Compaction lancée par la commande /compact',
  'chat.compaction.tooltip.overflow': 'La fenêtre de contexte était pleine',
  'chat.compaction.tooltip.tokens': 'Contexte : {before} → {after} tokens',
  'chat.compaction.tooltip.tokensShare': '{percent}% de la limite de contexte',
  'chat.compaction.tooltip.tokensBefore': 'Contexte avant : {tokens} tokens',
  'chat.compaction.tooltip.tokensAfter': 'Contexte après : {tokens} tokens',
  'chat.compaction.tooltip.viewSummary': 'Cliquez pour voir le résumé qui a remplacé les messages précédents',
  'chat.compaction.tooltip.effect': 'Le résumé remplace les messages précédents dans le contexte du modèle.',
  'chat.compaction.tooltip.time': 'Compacté {time}',
  ...
  'chat.toolPart.openSubtaskDialog': 'Ouvrir la sous-tâche dans une fenêtre',
