...
export const dict = {
  ...
  'rightSidebar.contextNotesTodo.plans.sharedBadge': 'Partagé',
  'rightSidebar.contextNotesTodo.plans.share': 'Partager avec l\'équipe',
  'rightSidebar.contextNotesTodo.plans.makePersonal': 'Rendre personnel',
  'rightSidebar.contextNotesTodo.plans.shareNeedsFolder': 'Définissez un dossier de plans partagés dans les réglages du projet pour partager des plans',
  ...
  'projectActions.menu.sharedBadge': 'partagé',
  'projects.sharedTrust.title': 'Exécuter les commandes partagées de l\'équipe ?',
