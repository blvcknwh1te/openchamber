...
export const dict = {
  ...
  'gitView.context.ariaLabel': 'Contexte de l’opération de gestion de code',
  ...
  'gitView.context.ready': 'Prêt',
  'gitView.context.needsAttention': 'À vérifier',
  'gitView.context.readiness.confirmationRequired': 'Doit être confirmé avant utilisation',
  'gitView.context.readiness.accountUnavailable': 'Le compte lié n\'est plus disponible',
  ...
  'gitView.context.stale': 'Dernier contexte enregistré, vérification en attente',
  'gitView.context.provider': 'Fournisseur',
  'gitView.context.author': 'Auteur',
  'gitView.context.notConfigured': 'Non configuré',
