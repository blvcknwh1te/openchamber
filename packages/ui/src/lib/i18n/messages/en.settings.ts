...
export const settingsDict = {
  ...
  'settings.openchamber.customCss.section': 'Custom CSS',
  'settings.openchamber.customCss.sectionInfo': 'User-level CSS the VS Code runtime injects into every panel, after the theme.',
  'settings.openchamber.customCss.field.label': 'Custom CSS file',
  'settings.openchamber.customCss.field.infoWithPath': 'Edits apply live. File: {path}',
  'settings.openchamber.customCss.field.info': 'Edits apply live. The file lives in your OpenChamber config folder.',
  'settings.openchamber.customCss.actions.open': 'Open / create',
  'settings.openchamber.customCss.actions.reset': 'Reset to defaults',
  'settings.openchamber.customCss.resetDone': 'custom.css reset to the default template',
  'settings.openchamber.customCss.failed': 'Could not update custom.css',
  ...
  'settings.openchamber.visual.field.unifiedSlashEntitiesAria': 'Show commands and skills in one slash list',
  'settings.openchamber.visual.field.unifiedSlashEntities': 'Unified Slash Commands and Skills',
  'settings.openchamber.visual.field.unifiedSlashEntitiesInfo': 'Shows /commands and /skills in a single list and passes the path to their file to the agent, so it sees what you referenced next to your text. Off: the previous behaviour.',
