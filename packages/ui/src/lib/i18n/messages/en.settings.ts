...
export const settingsDict = {
  ...
  'settings.sourceControl.reset.title': 'Reset source control setup',
  'settings.sourceControl.reset.description': 'Remove all saved source control references for this repository.',
  'settings.sourceControl.reset.action': 'Reset source control setup',
  'settings.sourceControl.reset.confirmTitle': 'Reset source control setup?',
  'settings.sourceControl.reset.confirmDescription': 'This removes all provider, transport, and auxiliary references saved for this repository. Credentials, Git remotes and configuration, the worktree, and author identity are not changed.',
  'settings.sourceControl.reset.failed': 'The source control setup changed or could not be reset. Review the refreshed setup before trying again.',
  'settings.sourceControl.reset.confirmAction': 'Reset setup',
