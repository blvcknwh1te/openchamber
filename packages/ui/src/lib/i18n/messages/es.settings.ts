...
export const settingsDict = {
  'settings.sourceControl.ssh.title': 'Credenciales SSH administradas',
  'settings.sourceControl.ssh.load': 'Cargar claves del servidor',
  'settings.sourceControl.ssh.discover': 'Buscar claves del host',
  'settings.sourceControl.ssh.empty': 'No hay claves SSH administradas configuradas en este servidor.',
  'settings.sourceControl.ssh.hostSetup': 'La búsqueda solo comprueba archivos de clave privada inmediatos en el directorio ~/.ssh del usuario del servidor conectado. No inspecciona subdirectorios, enlaces simbólicos, la configuración SSH ni agentes. Las copias importadas permanecen en el directorio de datos del servidor. Para claves con frase de contraseña o disponibles solo mediante un agente, selecciona explícitamente el transporte del sistema; sus credenciales no están verificadas.',
  'settings.sourceControl.ssh.unreadable': 'La clave no se puede leer en el servidor. Corrige la configuración del host o selecciona Sistema.',
  'settings.sourceControl.ssh.changed': 'La huella de la clave ha cambiado. Corrige la configuración del host o selecciona Sistema.',
  'settings.sourceControl.ssh.unverifiable': 'La clave está cifrada o no se puede verificar. Corrige la configuración del host o selecciona Sistema.',
  'settings.sourceControl.ssh.insecurePermissions': 'Los permisos de la clave permiten el acceso de otros usuarios. Restringe el archivo del host antes de importarlo.',
  'settings.sourceControl.ssh.discoveredEmpty': 'No se encontraron claves privadas importables en el directorio aprobado del servidor.',
  'settings.sourceControl.ssh.discoveryTruncated': 'El directorio contiene más entradas que el límite de búsqueda. Algunos archivos no se inspeccionaron.',
  'settings.sourceControl.ssh.confirmFingerprint': 'He verificado esta huella: {fingerprint}',
  'settings.sourceControl.ssh.import': 'Importar clave',
  'settings.sourceControl.ssh.imported': 'La clave se copió al almacenamiento administrado del servidor. No se cambió ninguna vinculación de repositorio.',
  'settings.sourceControl.ssh.candidateExpired': 'Este resultado de búsqueda caducó. Vuelve a buscar claves del host.',
  'settings.sourceControl.ssh.candidateChanged': 'La clave del host cambió después de la búsqueda. Vuelve a buscarla antes de importarla.',
  'settings.sourceControl.ssh.confirmationMismatch': 'La huella confirmada no coincide con este resultado de búsqueda.',
  'settings.sourceControl.ssh.candidateUnavailable': 'La clave del host ya no está disponible para importar. Vuelve a buscar claves del host.',
  'settings.sourceControl.ssh.inventoryFull': 'El almacén de claves SSH administradas alcanzó su límite. Elimina una clave sin usar antes de importar otra.',
  'settings.sourceControl.ssh.operationFailed': 'La solicitud de SSH administrado falló. Vuelve a intentar la operación.',
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  'settings.gitlab.info': 'Conecta GitLab.com o una instancia autogestionada para solicitudes de fusión, incidencias y CI.',
  'settings.gitlab.instance.customLabel': 'Instancia de GitLab',
  'settings.gitlab.instance.customInfo': 'Usa un origen HTTPS. HTTP solo se permite para direcciones locales.',
  'settings.gitlab.actions.useInstance': 'Usar instancia',
  'settings.gitlab.status.checking': 'Comprobando conexión…',
  'settings.gitlab.status.operationFailed': 'La operación falló',
  'settings.gitlab.status.notConnected': 'No conectado',
  'settings.gitlab.status.connected': 'Conectado',
  'settings.gitlab.actions.connect': 'Conectar GitLab',
  'settings.gitlab.token.label': 'Token de acceso personal',
  'settings.gitlab.token.info': 'El servidor de OpenChamber guarda el token y nunca lo devuelve a la interfaz.',
  'settings.gitlab.device.label': 'Código del dispositivo',
  'settings.gitlab.cli.label': 'glab CLI',
  'settings.gitlab.cli.info': 'Usa las credenciales de glab cuando no haya una cuenta guardada activa.',
  'settings.gitlab.actions.enableCli': 'Activar glab',
  'settings.gitlab.actions.disableCli': 'Desactivar glab',
  'settings.gitlab.instances.title': 'Instancias',
  'settings.gitlab.actions.addInstance': 'Añadir instancia',
  'settings.gitlab.device.waiting': 'Autoriza el dispositivo en GitLab y vuelve a OpenChamber. Esta página se actualizará automáticamente.',
  'settings.gitlab.actions.openGitLab': 'Abrir GitLab',
  'settings.sourceControl.accounts.available': 'Disponible',
  'settings.sourceControl.accounts.configured': 'Cuentas configuradas',
  'settings.sourceControl.accounts.connectedCount': '{count} cuentas',
  'settings.sourceControl.accounts.needsAuthentication': 'Requiere autenticación',
  'settings.sourceControl.actions.reauthenticate': 'Volver a autenticar',
  'settings.sourceControl.actions.remove': 'Eliminar',
  'settings.sourceControl.binding.accountLabel': 'Cuenta de control de código',
  'settings.sourceControl.binding.accountAriaLabel': 'Cuenta de control de código para el repositorio activo',
  'settings.sourceControl.binding.noAccounts': 'No hay cuentas compatibles',
  'settings.sourceControl.binding.noRepository': 'Abre un repositorio Git para configurar su cuenta de control de código.',
  'settings.sourceControl.binding.loading': 'Cargando vinculación del repositorio…',
  'settings.sourceControl.binding.suggested': 'Confirma la cuenta sugerida antes de que OpenChamber la use para este repositorio.',
  'settings.sourceControl.binding.configured': 'Esta cuenta se usa para las acciones de la API de control de código en el repositorio activo.',
  'settings.sourceControl.binding.confirm': 'Confirmar cuenta',
  'settings.sourceControl.transport.credentialAccount': 'Cuenta de credenciales HTTPS',
  'settings.sourceControl.transport.retry': 'Recargar y volver a intentar',
  'settings.sourceControl.transport.unverifiedConfirmation': 'Entiendo que Git del sistema usa las credenciales del host Git conectado. OpenChamber no puede verificar a qué cuenta pertenecen.',
  'settings.sourceControl.transport.info': 'Vincula un remoto del repositorio con Git del sistema o con una credencial gestionada por el host. Las cuentas de API del proveedor permanecen separadas.',
  'settings.sourceControl.transport.remoteLabel': 'Remoto',
  'settings.sourceControl.transport.remoteAriaLabel': 'Remoto Git que se configurará',
  'settings.sourceControl.transport.noRemotes': 'No hay remotos Git',
  'settings.sourceControl.transport.modeLabel': 'Credenciales',
  'settings.sourceControl.transport.modeAriaLabel': 'Transporte Git para el remoto seleccionado',
  'settings.sourceControl.transport.choose': 'Elegir transporte',
  'settings.sourceControl.transport.system': 'Git del sistema',
  'settings.sourceControl.transport.anonymous': 'HTTPS anónimo, solo lectura',
  'settings.sourceControl.transport.https': 'HTTPS gestionado',
  'settings.sourceControl.transport.ssh': 'Clave SSH gestionada',
  'settings.sourceControl.transport.bind': 'Vincular repositorio',
  'settings.sourceControl.transport.noRepository': 'Abre un repositorio Git para configurar su transporte.',
  'settings.sourceControl.transport.loading': 'Cargando el transporte del repositorio…',
  'settings.sourceControl.transport.missing': 'Elige un remoto y un transporte para vincular este repositorio.',
  'settings.sourceControl.transport.needsAttention': 'La configuración de Git cambió. Revisa y vuelve a guardar la vinculación de transporte.',
  'settings.sourceControl.transport.configured': 'El remoto seleccionado tiene una vinculación explícita de transporte Git.',
  'settings.sourceControl.transport.remove': 'Eliminar permiso de transporte',
  'settings.sourceControl.reset.title': 'Restablecer configuración de control de código',
  'settings.sourceControl.reset.description': 'Elimina todas las referencias de control de código guardadas para este repositorio.',
  'settings.sourceControl.reset.action': 'Restablecer control de código',
  'settings.sourceControl.reset.confirmTitle': '¿Restablecer la configuración de control de código?',
  'settings.sourceControl.reset.confirmDescription': 'Se eliminarán todas las referencias de proveedor, transporte y auxiliares guardadas para este repositorio. No se modificarán las credenciales, los remotos ni la configuración de Git, el árbol de trabajo ni la identidad del autor.',
  'settings.sourceControl.reset.failed': 'La configuración de control de código cambió o no se pudo restablecer. Revisa la configuración actualizada antes de volver a intentarlo.',
  'settings.sourceControl.reset.confirmAction': 'Restablecer configuración',
