...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.customCss.section": "CSS personalizado",
  "settings.openchamber.customCss.sectionInfo": "CSS de nivel de usuario que el entorno de VS Code inserta en cada panel, después del tema.",
  "settings.openchamber.customCss.field.label": "Archivo CSS",
  "settings.openchamber.customCss.field.infoWithPath": "Los cambios se aplican al instante. Archivo: {path}",
  "settings.openchamber.customCss.field.info": "Los cambios se aplican al instante. El archivo está en tu carpeta de configuración de OpenChamber.",
  "settings.openchamber.customCss.actions.open": "Abrir / crear",
  "settings.openchamber.customCss.actions.reset": "Restablecer valores predeterminados",
  "settings.openchamber.customCss.resetDone": "custom.css se restableció a la plantilla predeterminada",
  "settings.openchamber.customCss.failed": "No se pudo actualizar custom.css",
  ...
  "settings.openchamber.visual.field.unifiedSlashEntitiesAria": "Mostrar comandos y skills en una sola lista",
  "settings.openchamber.visual.field.unifiedSlashEntities": "Comandos y skills unificados",
  "settings.openchamber.visual.field.unifiedSlashEntitiesInfo": "Muestra los /comandos y /skills en una sola lista y pasa al agente la ruta a su archivo, para que vea a qué te refieres junto a tu texto. Desactivado: comportamiento anterior.",
