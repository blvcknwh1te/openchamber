...
export const dict = {
  ...
  'sessions.sidebar.session.tooltip.cost': 'Cost: {cost}',
  ...
  'chat.compaction.tooltip.automatic': 'Compaction ran automatically',
  'chat.compaction.tooltip.manual': 'Compaction ran from the /compact command',
  'chat.compaction.tooltip.overflow': 'The context window was full',
  'chat.compaction.tooltip.tokens': 'Context: {before} → {after} tokens',
  'chat.compaction.tooltip.tokensShare': '{percent}% of the context limit',
  'chat.compaction.tooltip.tokensBefore': 'Context before: {tokens} tokens',
  'chat.compaction.tooltip.tokensAfter': 'Context after: {tokens} tokens',
  'chat.compaction.tooltip.viewSummary': 'Click to view the summary that replaced the earlier messages',
  'chat.compaction.tooltip.effect': 'The summary replaces the earlier messages in the model context.',
  'chat.compaction.tooltip.time': 'Compacted {time}',
  ...
  'chat.toolPart.openSubtaskDialog': 'Open subtask in a dialog',
