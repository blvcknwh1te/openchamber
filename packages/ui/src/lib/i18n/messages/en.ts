...
export const dict = {
  ...
  'gitView.context.ariaLabel': 'Source control operation context',
  'gitView.context.configure': 'Configure repository',
  'gitView.context.draft': 'Selections are drafts until saved. Closing discards unsaved selections. Accounts and author profiles are managed in Git Settings.',
  'gitView.context.transport': 'Transport',
  'gitView.context.ready': 'Ready',
  'gitView.context.needsAttention': 'Needs attention',
  'gitView.context.readiness.confirmationRequired': 'Needs confirmation before it can be used',
  'gitView.context.readiness.accountUnavailable': 'The bound account is no longer available',
  ...
  'gitView.context.stale': 'Last saved context, awaiting verification',
  'gitView.context.provider': 'Provider',
  'gitView.context.author': 'Author',
  'gitView.context.notConfigured': 'Not configured',
