...
export const dict = {
  ...
  'rightSidebar.contextNotesTodo.plans.sharedBadge': 'Shared',
  'rightSidebar.contextNotesTodo.plans.share': 'Share with team',
  'rightSidebar.contextNotesTodo.plans.makePersonal': 'Make personal',
  'rightSidebar.contextNotesTodo.plans.shareNeedsFolder': 'Set a shared plans folder in Project settings to share plans',
  ...
  'projectActions.menu.sharedBadge': 'shared',
  'projects.sharedTrust.title': 'Run the team\'s shared commands?',
