...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.session.tooltip.model": "Modelo: {model}",
  "sessions.sidebar.session.tooltip.cost": "Costo: {cost}",
  "sessions.sidebar.session.tooltip.tokens": "Tokens: {tokens}",
  ...
  "chat.compaction.tooltip.automatic": "La compactación se ejecutó automáticamente",
  "chat.compaction.tooltip.manual": "La compactación se ejecutó con el comando /compact",
  "chat.compaction.tooltip.overflow": "La ventana de contexto estaba llena",
  'chat.compaction.tooltip.tokens': 'Contexto: {before} → {after} tokens',
  'chat.compaction.tooltip.tokensShare': '{percent}% del límite de contexto',
  'chat.compaction.tooltip.tokensBefore': 'Contexto antes: {tokens} tokens',
  'chat.compaction.tooltip.tokensAfter': 'Contexto después: {tokens} tokens',
  'chat.compaction.tooltip.viewSummary': 'Haz clic para ver el resumen que sustituyó a los mensajes anteriores',
  "chat.compaction.tooltip.effect": "El resumen sustituye los mensajes anteriores en el contexto del modelo.",
  "chat.compaction.tooltip.time": "Compactado {time}",
  ...
  "chat.toolPart.openSubtaskDialog": "Abrir subtarea en un cuadro de diálogo",
