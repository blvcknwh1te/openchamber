...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.context.transport': 'Transporte',
  'gitView.context.ready': 'Listo',
  'gitView.context.needsAttention': 'Requiere atención',
  'gitView.context.readiness.confirmationRequired': 'Necesita confirmación antes de poder usarse',
  'gitView.context.readiness.accountUnavailable': 'La cuenta vinculada ya no está disponible',
  'gitView.context.readiness.configChanged': 'Los remotos del repositorio cambiaron desde que se vinculó',
  'gitView.context.removeProvider': 'Quitar asociación con el proveedor',
  'gitView.context.systemUnverified': 'Credenciales del sistema, sin verificar',
  'gitView.context.managedCredentialUnavailable': 'Credencial gestionada no disponible',
  'gitView.context.applyAuthor': 'Aplicar autor a este repositorio',
  'gitView.context.settings': 'Abrir ajustes de Git',
  'gitView.context.stale': 'Último contexto guardado, pendiente de verificación',
  ...
  "gitView.context.ariaLabel": "Contexto de la operación de control de código",
  "gitView.context.provider": "Proveedor",
  "gitView.context.author": "Autor",
  "gitView.context.notConfigured": "Sin configurar",
