...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.session.tooltip.cost": "Custo: {cost}",
  ...
  "chat.compaction.tooltip.automatic": "A compactação foi executada automaticamente",
  "chat.compaction.tooltip.manual": "A compactação foi executada pelo comando /compact",
  "chat.compaction.tooltip.overflow": "A janela de contexto estava cheia",
  'chat.compaction.tooltip.tokens': 'Contexto: {before} → {after} tokens',
  'chat.compaction.tooltip.tokensShare': '{percent}% do limite de contexto',
  'chat.compaction.tooltip.tokensBefore': 'Contexto antes: {tokens} tokens',
  'chat.compaction.tooltip.tokensAfter': 'Contexto depois: {tokens} tokens',
  'chat.compaction.tooltip.viewSummary': 'Clique para ver o resumo que substituiu as mensagens anteriores',
  "chat.compaction.tooltip.effect": "O resumo substitui as mensagens anteriores no contexto do modelo.",
  ...
  "chat.toolPart.openSubtaskDialog": "Abrir subtarefa em uma janela",
