...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.context.draft': 'As seleções são rascunhos até serem salvas. Fechar descarta as seleções não salvas. Contas e perfis de autor são gerenciados nas configurações do Git.',
  'gitView.context.transport': 'Transporte',
  'gitView.context.ready': 'Pronto',
  'gitView.context.needsAttention': 'Requer atenção',
  'gitView.context.readiness.confirmationRequired': 'Precisa de confirmação antes de ser usado',
  'gitView.context.readiness.accountUnavailable': 'A conta vinculada não está mais disponível',
  ...
  'gitView.context.stale': 'Último contexto salvo, aguardando verificação',
  ...
  "gitView.context.ariaLabel": "Contexto da operação de controle de código",
  "gitView.context.provider": "Provedor",
  "gitView.context.author": "Autor",
  "gitView.context.notConfigured": "Não configurado",
