...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.tooltip.model': '모델: {model}',
  'sessions.sidebar.session.tooltip.cost': '비용: {cost}',
  'sessions.sidebar.session.tooltip.tokens': '토큰: {tokens}',
  ...
  'chat.compaction.tooltip.automatic': '컨텍스트 압축이 자동으로 실행되었습니다',
  'chat.compaction.tooltip.manual': '/compact 명령으로 컨텍스트 압축이 실행되었습니다',
  'chat.compaction.tooltip.overflow': '컨텍스트 창이 가득 찼습니다',
  'chat.compaction.tooltip.tokens': '컨텍스트: {before} → {after} 토큰',
  'chat.compaction.tooltip.tokensShare': '컨텍스트 한도의 {percent}%',
  'chat.compaction.tooltip.tokensBefore': '컨텍스트(이전): {tokens} 토큰',
  'chat.compaction.tooltip.tokensAfter': '컨텍스트(이후): {tokens} 토큰',
  'chat.compaction.tooltip.viewSummary': '이전 메시지를 대체한 요약을 보려면 클릭하세요',
  'chat.compaction.tooltip.effect': '요약이 이전 메시지를 대신해 모델 컨텍스트에 들어갑니다.',
  'chat.compaction.tooltip.time': '{time}에 압축됨',
  ...
  'chat.toolPart.openSubtaskDialog': '하위 작업을 대화상자에서 열기',
  'chat.todo.total': '전체',
