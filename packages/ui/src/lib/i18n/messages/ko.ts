...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.context.ariaLabel': '소스 제어 작업 컨텍스트',
  ...
  'gitView.context.transport': '전송 방식',
  'gitView.context.ready': '준비됨',
  'gitView.context.needsAttention': '확인 필요',
  'gitView.context.readiness.confirmationRequired': '사용하려면 먼저 확인이 필요합니다',
  'gitView.context.readiness.accountUnavailable': '연결된 계정을 더 이상 사용할 수 없습니다',
  ...
  'gitView.context.stale': '마지막 저장 컨텍스트, 확인 대기 중',
  'gitView.context.provider': '공급자',
  'gitView.context.author': '작성자',
  'gitView.context.notConfigured': '구성되지 않음',
