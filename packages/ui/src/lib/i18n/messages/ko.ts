...
export const dict: Record<I18nKey, string> = {
  ...
  'rightSidebar.contextNotesTodo.plans.sharedBadge': '공유됨',
  'rightSidebar.contextNotesTodo.plans.share': '팀과 공유',
  'rightSidebar.contextNotesTodo.plans.makePersonal': '개인용으로 전환',
  'rightSidebar.contextNotesTodo.plans.shareNeedsFolder': '플랜을 공유하려면 프로젝트 설정에서 공유 플랜 폴더를 지정하세요',
  ...
  'projectActions.menu.sharedBadge': '공유',
  'projects.sharedTrust.title': '팀의 공유 명령을 실행할까요?',
