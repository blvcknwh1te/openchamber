...
'settings.remoteInstances.clientAuth.actions.addDevice': 'デバイスを追加',
  ...
  'settings.openchamber.customCss.section': 'カスタム CSS',
  'settings.openchamber.customCss.sectionInfo': 'VS Code ランタイムがテーマの後に各パネルへ挿入するユーザーレベルの CSS です。',
  'settings.openchamber.customCss.field.label': 'CSS ファイル',
  'settings.openchamber.customCss.field.infoWithPath': '編集は即時反映されます。ファイル: {path}',
  'settings.openchamber.customCss.field.info': '編集は即時反映されます。ファイルは OpenChamber の設定フォルダーにあります。',
  'settings.openchamber.customCss.actions.open': '開く / 作成',
  'settings.openchamber.customCss.actions.reset': '既定値に戻す',
  'settings.openchamber.customCss.resetDone': 'custom.css を既定のテンプレートに戻しました',
  'settings.openchamber.customCss.failed': 'custom.css を更新できませんでした',
  ...
  'settings.openchamber.visual.field.unifiedSlashEntitiesAria': 'コマンドとスキルを1つのスラッシュリストに表示',
  'settings.openchamber.visual.field.unifiedSlashEntities': 'スラッシュコマンドとスキルの統合',
  'settings.openchamber.visual.field.unifiedSlashEntitiesInfo': '/コマンドと/skillを1つのリストに表示し、エージェントにそのファイルのパスを渡します。これにより、テキストの横で何を参照しているかをエージェントが把握できます。オフ：以前の動作。',
