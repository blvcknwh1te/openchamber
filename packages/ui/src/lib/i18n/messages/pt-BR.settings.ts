...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.projects.shared.badge": "Compartilhado",
  "settings.projects.shared.actionsFromRepo": "Compartilhado pela equipe em {path}",
  "settings.projects.shared.commandsFromRepo": "Executados primeiro, compartilhados pela equipe em {path}",
  "settings.projects.shared.invalid": "A configuração compartilhada em {path} não pôde ser lida: {reason}",
  "settings.projects.shared.trusted": "Confiável nesta instância",
  "settings.projects.shared.resetTrust": "Redefinir confiança",
  "settings.projects.shared.title": "Configuração compartilhada",
  "settings.projects.shared.description": "Configuração que este projeto compartilha com a equipe por um arquivo no repositório. Nada é gravado até você compartilhar um item.",
  ...
  "settings.projects.shared.plansDir": "Pasta de planos compartilhados",
  "settings.projects.shared.plansDirPlaceholder": "ex.: docs/plans",
  "settings.projects.shared.plansDirInfo": "Uma pasta dentro do repositório. Os planos ali são compartilhados com a equipe e aparecem na aba Planos; deixe vazio para manter os planos pessoais.",
  "settings.projects.shared.plansDirAria": "Pasta de planos compartilhados",
  "settings.projects.shared.actions.share": "Compartilhar com a equipe",
  "settings.projects.shared.actions.makePersonal": "Tornar pessoal",
  ...
  "settings.projects.shared.replaceMode": "Usar apenas meus comandos de configuração",
  "settings.projects.shared.replaceModeAria": "Usar apenas meus comandos de configuração e ignorar os da equipe",
  "settings.projects.shared.toast.shareFailed": "Falha ao atualizar a configuração compartilhada",
