...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  'settings.sourceControl.reset.title': 'Redefinir configuração de controle de código',
  'settings.sourceControl.reset.description': 'Remova todas as referências de controle de código salvas para este repositório.',
  'settings.sourceControl.reset.action': 'Redefinir controle de código',
  'settings.sourceControl.reset.confirmTitle': 'Redefinir a configuração de controle de código?',
  'settings.sourceControl.reset.confirmDescription': 'Isso remove todas as referências de provedor, transporte e auxiliares salvas para este repositório. As credenciais, os remotos e a configuração do Git, a árvore de trabalho e a identidade do autor não são alterados.',
  'settings.sourceControl.reset.failed': 'A configuração de controle de código mudou ou não pôde ser redefinida. Revise a configuração atualizada antes de tentar novamente.',
  'settings.sourceControl.reset.confirmAction': 'Redefinir configuração',
