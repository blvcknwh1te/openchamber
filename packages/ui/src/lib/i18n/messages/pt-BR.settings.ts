...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.customCss.sectionInfo": "CSS de nível de usuário que o ambiente do VS Code injeta em todos os painéis, depois do tema.",
  "settings.openchamber.customCss.field.label": "Arquivo CSS",
  "settings.openchamber.customCss.field.infoWithPath": "As alterações são aplicadas na hora. Arquivo: {path}",
  "settings.openchamber.customCss.field.info": "As alterações são aplicadas na hora. O arquivo fica na sua pasta de configuração do OpenChamber.",
  "settings.openchamber.customCss.actions.open": "Abrir / criar",
  "settings.openchamber.customCss.actions.reset": "Restaurar padrões",
  "settings.openchamber.customCss.resetDone": "custom.css restaurado para o modelo padrão",
  "settings.openchamber.customCss.failed": "Não foi possível atualizar o custom.css",
  ...
  "settings.openchamber.visual.field.unifiedSlashEntitiesAria": "Mostrar comandos e skills em uma única lista",
  "settings.openchamber.visual.field.unifiedSlashEntities": "Comandos e skills unificados",
  "settings.openchamber.visual.field.unifiedSlashEntitiesInfo": "Mostra /comandos e /skills em uma única lista e envia ao agente o caminho do arquivo deles, para que ele veja o que você mencionou ao lado do texto. Desativado: comportamento anterior.",
