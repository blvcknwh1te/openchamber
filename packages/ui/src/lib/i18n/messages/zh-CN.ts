...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.context.ariaLabel': '源代码管理操作上下文',
  'gitView.context.configure': '配置仓库',
  'gitView.context.draft': '选择在保存前仅为草稿。关闭会放弃未保存的选择。请在 Git 设置中管理账户和作者配置。',
  'gitView.context.transport': '传输方式',
  'gitView.context.ready': '就绪',
  'gitView.context.needsAttention': '需要处理',
  'gitView.context.readiness.confirmationRequired': '使用前需要确认',
  'gitView.context.readiness.accountUnavailable': '绑定的账户已不可用',
  ...
  'gitView.context.stale': '上次保存的上下文，等待验证',
  'gitView.context.provider': '提供商',
  'gitView.context.author': '作者',
  'gitView.context.notConfigured': '未配置',
