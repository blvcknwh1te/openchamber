...
export const dict: Record<I18nKey, string> = {
  ...
  'rightSidebar.contextNotesTodo.plans.sharedBadge': '共享',
  'rightSidebar.contextNotesTodo.plans.share': '与团队共享',
  'rightSidebar.contextNotesTodo.plans.makePersonal': '设为个人',
  'rightSidebar.contextNotesTodo.plans.shareNeedsFolder': '在项目设置中设置共享计划文件夹后才能共享计划',
  ...
  'chat.draftStarters.sharedTitle': '由团队固定；请在仓库中修改',
  'chat.draftStarters.share': '与团队共享',
  'chat.draftStarters.makePersonal': '设为个人',
  ...
  'projectActions.menu.sharedBadge': '共享',
  'projects.sharedTrust.title': '运行团队的共享命令？',
