...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.tooltip.cost': '费用：{cost}',
  'sessions.sidebar.session.tooltip.tokens': '令牌：{tokens}',
  ...
  'chat.compaction.tooltip.automatic': '上下文压缩已自动执行',
  'chat.compaction.tooltip.manual': '上下文压缩由 /compact 命令执行',
  'chat.compaction.tooltip.overflow': '上下文窗口已满',
  'chat.compaction.tooltip.tokens': '上下文：{before} → {after} 个 Token',
  'chat.compaction.tooltip.tokensShare': '占上下文上限的 {percent}%',
  'chat.compaction.tooltip.tokensBefore': '上下文（压缩前）：{tokens} 个 Token',
  'chat.compaction.tooltip.tokensAfter': '上下文（压缩后）：{tokens} 个 Token',
  'chat.compaction.tooltip.viewSummary': '点击查看替换先前消息的摘要',
  'chat.compaction.tooltip.effect': '摘要会取代模型上下文中较早的消息。',
  'chat.compaction.tooltip.time': '压缩于 {time}',
  ...
  'chat.toolPart.openSubtaskDialog': '在对话框中打开子任务',
  'chat.todo.total': '总计',
