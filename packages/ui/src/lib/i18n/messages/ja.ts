...
export const dict: Record<I18nKey, string> = {
  ...
  'rightSidebar.contextNotesTodo.plans.sharedBadge': '共有',
  'rightSidebar.contextNotesTodo.plans.share': 'チームと共有',
  'rightSidebar.contextNotesTodo.plans.makePersonal': '個人用にする',
  'rightSidebar.contextNotesTodo.plans.shareNeedsFolder': 'プランを共有するには、プロジェクト設定で共有プランのフォルダーを設定してください',
  ...
  'projectActions.menu.sharedBadge': '共有',
  'projects.sharedTrust.title': 'チームの共有コマンドを実行しますか？',
