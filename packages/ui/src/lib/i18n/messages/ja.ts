...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.tooltip.model': 'モデル: {model}',
  'sessions.sidebar.session.tooltip.cost': 'コスト: {cost}',
  'sessions.sidebar.session.tooltip.tokens': 'トークン: {tokens}',
  ...
  'chat.compaction.tooltip.automatic': 'コンテキストの圧縮が自動で実行されました',
  'chat.compaction.tooltip.manual': 'コンテキストの圧縮が /compact コマンドで実行されました',
  'chat.compaction.tooltip.overflow': 'コンテキストウィンドウが満杯でした',
  'chat.compaction.tooltip.tokens': 'コンテキスト: {before} → {after} トークン',
  'chat.compaction.tooltip.tokensShare': 'コンテキスト上限の {percent}%',
  'chat.compaction.tooltip.tokensBefore': 'コンテキスト（変更前）: {tokens} トークン',
  'chat.compaction.tooltip.tokensAfter': 'コンテキスト（変更後）: {tokens} トークン',
  'chat.compaction.tooltip.viewSummary': '以前のメッセージを置き換えた要約を表示するにはクリック',
  'chat.compaction.tooltip.effect': '要約が、それ以前のメッセージに代わってモデルのコンテキストに入ります。',
  'chat.compaction.tooltip.time': '{time} に圧縮',
  ...
  'chat.toolPart.openSubtaskDialog': 'サブタスクをダイアログで開く',
  'chat.todo.total': '合計',
