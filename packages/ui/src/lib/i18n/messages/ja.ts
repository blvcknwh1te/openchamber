...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.context.ariaLabel': 'ソース管理操作のコンテキスト',
  'gitView.context.configure': 'リポジトリを設定',
  'gitView.context.draft': '選択内容は保存するまで下書きです。閉じると未保存の選択は破棄されます。アカウントと作成者プロファイルはGit設定で管理します。',
  'gitView.context.transport': '転送方式',
  'gitView.context.ready': '準備完了',
  'gitView.context.needsAttention': '確認が必要',
  'gitView.context.readiness.confirmationRequired': '使用する前に確認が必要です',
  'gitView.context.readiness.accountUnavailable': '関連付けられたアカウントは利用できません',
  ...
  'gitView.context.stale': '前回保存したコンテキスト、検証待ち',
  'gitView.context.provider': 'プロバイダー',
  'gitView.context.author': '作成者',
  'gitView.context.notConfigured': '未設定',
