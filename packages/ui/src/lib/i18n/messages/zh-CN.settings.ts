...
export const settingsDict = {
  'settings.sourceControl.ssh.title': '托管 SSH 凭据',
  'settings.sourceControl.ssh.load': '加载服务器密钥',
  'settings.sourceControl.ssh.discover': '查找主机密钥',
  'settings.sourceControl.ssh.empty': '此服务器尚未配置托管 SSH 密钥。',
  'settings.sourceControl.ssh.hostSetup': '查找仅检查已连接服务器用户的 ~/.ssh 目录中直接包含的私钥文件，不检查子目录、符号链接、SSH 配置或代理。导入的副本保留在服务器数据目录中。对于受口令保护或仅存在于代理中的密钥，请明确选择系统传输；其凭据未经验证。',
  'settings.sourceControl.ssh.unreadable': '服务器无法读取密钥。请修复主机配置或选择系统传输。',
  'settings.sourceControl.ssh.changed': '密钥指纹已更改。请修复主机配置或选择系统传输。',
  'settings.sourceControl.ssh.unverifiable': '密钥已加密或无法验证。请修复主机配置或选择系统传输。',
  'settings.sourceControl.ssh.insecurePermissions': '密钥权限允许其他用户访问。请在导入前限制主机文件的权限。',
  'settings.sourceControl.ssh.discoveredEmpty': '在获准的服务器目录中未找到可导入的私钥。',
  'settings.sourceControl.ssh.discoveryTruncated': '目录条目数超过查找限制，部分文件未被检查。',
  'settings.sourceControl.ssh.confirmFingerprint': '我已核对此指纹：{fingerprint}',
  'settings.sourceControl.ssh.import': '导入密钥',
  'settings.sourceControl.ssh.imported': '密钥已复制到服务器托管存储中。未更改任何仓库绑定。',
  'settings.sourceControl.ssh.candidateExpired': '此查找结果已过期。请重新查找主机密钥。',
  'settings.sourceControl.ssh.candidateChanged': '主机密钥在查找后发生了变化。请在导入前重新查找。',
  'settings.sourceControl.ssh.confirmationMismatch': '确认的指纹与此查找结果不匹配。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.gitlab.info': '连接 GitLab.com 或自托管 GitLab 实例，以使用合并请求、议题和 CI。',
  'settings.gitlab.instance.customLabel': 'GitLab 实例',
  'settings.gitlab.instance.customInfo': '请使用 HTTPS 源地址。仅本地地址允许使用 HTTP。',
  ...
  'settings.gitlab.device.label': '设备代码',
  'settings.gitlab.cli.label': 'glab CLI',
  'settings.gitlab.cli.info': '没有活动的已保存账户时使用 glab 凭据。',
  'settings.gitlab.actions.enableCli': '启用 glab',
  'settings.gitlab.actions.disableCli': '禁用 glab',
  'settings.gitlab.instances.title': '实例',
  ...
  'settings.sourceControl.accounts.needsAuthentication': '需要身份验证',
  'settings.sourceControl.actions.reauthenticate': '重新验证',
  'settings.sourceControl.actions.remove': '移除',
  'settings.sourceControl.binding.accountLabel': '源代码管理账户',
  'settings.sourceControl.binding.accountAriaLabel': '当前仓库的源代码管理账户',
  'settings.sourceControl.binding.noAccounts': '没有匹配的账户',
  'settings.sourceControl.binding.noRepository': '打开 Git 仓库以配置其源代码管理账户。',
  'settings.sourceControl.binding.loading': '正在加载仓库绑定…',
  'settings.sourceControl.binding.suggested': '请先确认建议的账户，OpenChamber 才会将其用于此仓库。',
  'settings.sourceControl.binding.configured': '此账户用于当前仓库中的源代码管理 API 操作。',
  'settings.sourceControl.binding.confirm': '确认账户',
  'settings.sourceControl.transport.credentialAccount': 'HTTPS 凭据账号',
  'settings.sourceControl.transport.retry': '重新加载并重试',
  'settings.sourceControl.transport.unverifiedConfirmation': '我了解系统 Git 会使用已连接 Git 主机上的凭据。OpenChamber 无法验证这些凭据属于哪个账号。',
  'settings.sourceControl.transport.info': '将仓库远程绑定到系统 Git 或由主机管理的凭据。提供商 API 账户保持独立。',
  'settings.sourceControl.transport.remoteLabel': '远程',
  'settings.sourceControl.transport.remoteAriaLabel': '要配置的 Git 远程',
  'settings.sourceControl.transport.noRemotes': '没有 Git 远程',
  'settings.sourceControl.transport.modeLabel': '传输',
  'settings.sourceControl.transport.modeAriaLabel': '所选远程的 Git 传输方式',
  'settings.sourceControl.transport.choose': '选择传输方式',
  'settings.sourceControl.transport.system': '系统 Git',
  'settings.sourceControl.transport.anonymous': '匿名 HTTPS，只读',
  'settings.sourceControl.transport.https': '托管 HTTPS',
  'settings.sourceControl.transport.ssh': '托管 SSH 密钥',
  'settings.sourceControl.transport.bind': '绑定仓库',
  'settings.sourceControl.transport.noRepository': '打开 Git 仓库以配置其传输方式。',
  'settings.sourceControl.transport.loading': '正在加载仓库传输设置…',
  'settings.sourceControl.transport.missing': '选择远程和传输方式以绑定此仓库。',
  'settings.sourceControl.transport.needsAttention': 'Git 配置已更改。请检查并重新保存传输绑定。',
  'settings.sourceControl.transport.configured': '所选远程具有显式 Git 传输绑定。',
  'settings.sourceControl.transport.remove': '移除传输授权',
  'settings.sourceControl.reset.title': '重置源代码管理设置',
  'settings.sourceControl.reset.description': '移除此仓库保存的所有源代码管理引用。',
  'settings.sourceControl.reset.action': '重置源代码管理设置',
  'settings.sourceControl.reset.confirmTitle': '重置源代码管理设置？',
  'settings.sourceControl.reset.confirmDescription': '这会移除此仓库保存的所有提供商、传输和辅助引用。凭据、Git 远程和配置、工作树以及作者身份均不会更改。',
  'settings.sourceControl.reset.failed': '源代码管理设置已更改或无法重置。请先检查刷新后的设置，再重试。',
  'settings.sourceControl.reset.confirmAction': '重置设置',
