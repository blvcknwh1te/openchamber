...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.projects.shared.badge': '共享',
  'settings.projects.shared.actionsFromRepo': '团队在 {path} 中共享',
  'settings.projects.shared.commandsFromRepo': '首先运行，团队在 {path} 中共享',
  'settings.projects.shared.invalid': '无法读取 {path} 中的共享配置：{reason}',
  'settings.projects.shared.trusted': '已在此实例上信任',
  'settings.projects.shared.resetTrust': '重置信任',
  'settings.projects.shared.title': '共享配置',
  'settings.projects.shared.description': '此项目通过仓库中的文件与团队共享的设置。在你共享某个项目之前不会写入任何内容。',
  'settings.projects.shared.file': '文件',
  'settings.projects.shared.status.missing': '尚未在仓库中',
  'settings.projects.shared.status.ok': '已在仓库中',
  'settings.projects.shared.plansDir': '共享计划文件夹',
  'settings.projects.shared.plansDirPlaceholder': '例如 docs/plans',
  'settings.projects.shared.plansDirInfo': '仓库内的一个文件夹。其中的计划与团队共享并显示在“计划”标签中；留空则计划保持为个人。',
  'settings.projects.shared.plansDirAria': '共享计划文件夹',
  'settings.projects.shared.actions.share': '与团队共享',
  'settings.projects.shared.actions.makePersonal': '设为个人',
  ...
  'settings.projects.shared.replaceMode': '仅使用我的设置命令',
  'settings.projects.shared.replaceModeAria': '仅使用我的设置命令，跳过团队的命令',
  'settings.projects.shared.toast.shareFailed': '更新共享配置失败',
