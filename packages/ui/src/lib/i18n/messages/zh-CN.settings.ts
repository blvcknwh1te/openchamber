...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.customCss.section': '自定义 CSS',
  'settings.openchamber.customCss.sectionInfo': 'VS Code 运行时在主题之后注入到每个面板的用户级 CSS。',
  'settings.openchamber.customCss.field.label': 'CSS 文件',
  'settings.openchamber.customCss.field.infoWithPath': '修改会立即生效。文件：{path}',
  'settings.openchamber.customCss.field.info': '修改会立即生效。该文件位于 OpenChamber 配置文件夹中。',
  'settings.openchamber.customCss.actions.open': '打开 / 创建',
  'settings.openchamber.customCss.actions.reset': '恢复默认值',
  'settings.openchamber.customCss.resetDone': 'custom.css 已恢复为默认模板',
  'settings.openchamber.customCss.failed': '无法更新 custom.css',
  ...
  'settings.openchamber.visual.field.unifiedSlashEntitiesAria': '在同一斜杠列表中显示命令与技能',
  'settings.openchamber.visual.field.unifiedSlashEntities': '统一的斜杠命令与技能',
  'settings.openchamber.visual.field.unifiedSlashEntitiesInfo': '将 /命令与 /技能显示在同一列表中，并把其文件路径传给智能体，使其能看到你在文本旁边引用的内容。关闭：沿用旧行为。',
