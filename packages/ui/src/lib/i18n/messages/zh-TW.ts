...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.context.ariaLabel': '原始碼管理操作內容',
  'gitView.context.configure': '設定儲存庫',
  'gitView.context.draft': '選擇在儲存前僅為草稿。關閉會捨棄尚未儲存的選擇。請在 Git 設定中管理帳戶和作者設定檔。',
  'gitView.context.transport': '傳輸方式',
  'gitView.context.ready': '就緒',
  'gitView.context.needsAttention': '需要處理',
  'gitView.context.readiness.confirmationRequired': '使用前需要確認',
  'gitView.context.readiness.accountUnavailable': '綁定的帳戶已不可用',
  ...
  'gitView.context.stale': '上次儲存的內容，等待驗證',
  'gitView.context.provider': '供應商',
