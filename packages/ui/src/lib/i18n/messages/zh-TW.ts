...
export const dict: Record<I18nKey, string> = {
  ...
  'rightSidebar.contextNotesTodo.plans.share': '與團隊共享',
  'rightSidebar.contextNotesTodo.plans.makePersonal': '設為個人',
  'rightSidebar.contextNotesTodo.plans.shareNeedsFolder': '在專案設定中設定共享計畫資料夾後才能共享計畫',
  ...
  'projects.sharedTrust.title': '執行團隊的共享命令？',
