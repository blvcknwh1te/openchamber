...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.tooltip.model': '模型：{model}',
  'sessions.sidebar.session.tooltip.cost': '費用：{cost}',
  'sessions.sidebar.session.tooltip.tokens': '權杖：{tokens}',
  ...
  'chat.compaction.tooltip.automatic': '上下文壓縮已自動執行',
  'chat.compaction.tooltip.manual': '上下文壓縮由 /compact 指令執行',
  'chat.compaction.tooltip.overflow': '上下文視窗已滿',
  'chat.compaction.tooltip.tokens': '上下文：{before} → {after} 個 Token',
  'chat.compaction.tooltip.tokensShare': '佔上下文上限的 {percent}%',
  'chat.compaction.tooltip.tokensBefore': '上下文（壓縮前）：{tokens} 個 Token',
  'chat.compaction.tooltip.tokensAfter': '上下文（壓縮後）：{tokens} 個 Token',
  'chat.compaction.tooltip.viewSummary': '點擊查看取代先前訊息的摘要',
  'chat.compaction.tooltip.effect': '摘要會取代模型上下文中較早的訊息。',
  'chat.compaction.tooltip.time': '壓縮於 {time}',
  ...
  'chat.toolPart.openSubtaskDialog': '在對話方塊中開啟子任務',
  'chat.todo.total': '總計',
