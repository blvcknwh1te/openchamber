...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.session.tooltip.model": "Модель: {model}",
  "sessions.sidebar.session.tooltip.cost": "Вартість: {cost}",
  "sessions.sidebar.session.tooltip.tokens": "Токени: {tokens}",
  ...
  "chat.compaction.tooltip.automatic": "Стиснення контексту виконано автоматично",
  "chat.compaction.tooltip.manual": "Стиснення контексту виконано командою /compact",
  "chat.compaction.tooltip.overflow": "Вікно контексту було заповнене",
  'chat.compaction.tooltip.tokens': 'Контекст: {before} → {after} токенів',
  'chat.compaction.tooltip.tokensShare': '{percent}% ліміту контексту',
  'chat.compaction.tooltip.tokensBefore': 'Контекст до: {tokens} токенів',
  'chat.compaction.tooltip.tokensAfter': 'Контекст після: {tokens} токенів',
  'chat.compaction.tooltip.viewSummary': 'Натисніть, щоб побачити підсумок, який замінив попередні повідомлення',
  "chat.compaction.tooltip.effect": "Підсумок замінює попередні повідомлення в контексті моделі.",
  "chat.compaction.tooltip.time": "Стиснуто {time}",
  ...
  "chat.toolPart.openSubtaskDialog": "Відкрити підзавдання у вікні",
