...
export const settingsDict = {
  ...
  'settings.projects.shared.badge': 'Partagé',
  ...
  'settings.projects.shared.title': 'Configuration partagée',
  'settings.projects.shared.description': 'Configuration que ce projet partage avec l\'équipe via un fichier dans le dépôt. Rien n\'est écrit tant que vous ne partagez pas un élément.',
  ...
  'settings.projects.shared.plansDir': 'Dossier des plans partagés',
  'settings.projects.shared.plansDirPlaceholder': 'ex. docs/plans',
  'settings.projects.shared.plansDirInfo': 'Un dossier dans le dépôt. Les plans qui s\'y trouvent sont partagés avec l\'équipe et apparaissent dans l\'onglet Plans ; laissez vide pour garder les plans personnels.',
  'settings.projects.shared.plansDirAria': 'Dossier des plans partagés',
  'settings.projects.shared.actions.share': 'Partager avec l\'équipe',
  'settings.projects.shared.actions.makePersonal': 'Rendre personnel',
  ...
  'settings.projects.shared.replaceMode': 'Utiliser uniquement mes commandes de configuration',
  'settings.projects.shared.replaceModeAria': 'Utiliser uniquement mes commandes de configuration et ignorer celles de l\'équipe',
  'settings.projects.shared.toast.shareFailed': 'Impossible de mettre à jour la configuration partagée',
