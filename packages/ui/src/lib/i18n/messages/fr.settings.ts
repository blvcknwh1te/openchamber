...
export const settingsDict = {
  'settings.sourceControl.ssh.title': 'Identifiants SSH gérés',
  'settings.sourceControl.ssh.load': 'Charger les clés du serveur',
  'settings.sourceControl.ssh.discover': 'Rechercher les clés de l’hôte',
  'settings.sourceControl.ssh.empty': 'Aucune clé SSH gérée n’est configurée sur ce serveur.',
  'settings.sourceControl.ssh.hostSetup': 'La recherche examine uniquement les fichiers de clé privée directement présents dans le dossier ~/.ssh de l’utilisateur du serveur connecté. Elle n’examine ni les sous-dossiers, ni les liens symboliques, ni la configuration SSH, ni les agents. Les copies importées restent dans le dossier de données du serveur. Pour les clés protégées par une phrase secrète ou disponibles uniquement dans un agent, choisissez explicitement le transport système ; ses identifiants ne sont pas vérifiés.',
  'settings.sourceControl.ssh.unreadable': 'La clé est illisible sur le serveur. Corrigez la configuration de l’hôte ou choisissez Système.',
  'settings.sourceControl.ssh.changed': 'L’empreinte de la clé a changé. Corrigez la configuration de l’hôte ou choisissez Système.',
  'settings.sourceControl.ssh.unverifiable': 'La clé est chiffrée ou ne peut pas être vérifiée. Corrigez la configuration de l’hôte ou choisissez Système.',
  'settings.sourceControl.ssh.insecurePermissions': 'Les autorisations de la clé permettent à d’autres utilisateurs d’y accéder. Restreignez le fichier de l’hôte avant de l’importer.',
  'settings.sourceControl.ssh.discoveredEmpty': 'Aucune clé privée importable n’a été trouvée dans le dossier approuvé du serveur.',
  'settings.sourceControl.ssh.discoveryTruncated': 'Le dossier contient plus d’entrées que la limite de recherche. Certains fichiers n’ont pas été examinés.',
  'settings.sourceControl.ssh.confirmFingerprint': 'J’ai vérifié cette empreinte : {fingerprint}',
  'settings.sourceControl.ssh.import': 'Importer la clé',
  'settings.sourceControl.ssh.imported': 'La clé a été copiée dans le stockage géré du serveur. Aucune liaison de dépôt n’a été modifiée.',
  'settings.sourceControl.ssh.candidateExpired': 'Ce résultat de recherche a expiré. Recherchez à nouveau les clés de l’hôte.',
  'settings.sourceControl.ssh.candidateChanged': 'La clé de l’hôte a changé après la recherche. Recherchez-la à nouveau avant de l’importer.',
  'settings.sourceControl.ssh.confirmationMismatch': 'L’empreinte confirmée ne correspond pas à ce résultat de recherche.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Ajouter un appareil',
  ...
  'settings.gitlab.info': 'Connectez GitLab.com ou une instance autogérée pour les demandes de fusion, les tickets et la CI.',
  'settings.gitlab.instance.customLabel': 'Instance GitLab',
  'settings.gitlab.instance.customInfo': 'Utilisez une origine HTTPS. HTTP est autorisé uniquement pour les adresses locales.',
  ...
  'settings.gitlab.token.label': 'Jeton d’accès personnel',
  'settings.gitlab.token.info': 'Le jeton est stocké par le serveur OpenChamber et n’est jamais renvoyé à l’interface.',
  'settings.gitlab.device.label': 'Code de l’appareil',
  'settings.gitlab.cli.label': 'glab CLI',
  'settings.gitlab.cli.info': 'Utiliser les identifiants glab lorsqu’aucun compte enregistré n’est actif.',
  'settings.gitlab.actions.enableCli': 'Activer glab',
  'settings.gitlab.actions.disableCli': 'Désactiver glab',
  ...
  'settings.sourceControl.accounts.needsAuthentication': 'Authentification requise',
  'settings.sourceControl.actions.reauthenticate': 'Se réauthentifier',
  'settings.sourceControl.actions.remove': 'Supprimer',
  'settings.sourceControl.binding.accountLabel': 'Compte de gestion de code',
  'settings.sourceControl.binding.accountAriaLabel': 'Compte de gestion de code du dépôt actif',
  'settings.sourceControl.binding.noAccounts': 'Aucun compte correspondant',
  'settings.sourceControl.binding.noRepository': 'Ouvrez un dépôt Git pour configurer son compte de gestion de code.',
  'settings.sourceControl.binding.loading': 'Chargement de l’association du dépôt…',
  'settings.sourceControl.binding.suggested': 'Confirmez le compte suggéré avant qu’OpenChamber ne l’utilise pour ce dépôt.',
  'settings.sourceControl.binding.configured': 'Ce compte est utilisé pour les actions de l’API de gestion de code dans le dépôt actif.',
  'settings.sourceControl.binding.confirm': 'Confirmer le compte',
  'settings.sourceControl.transport.credentialAccount': 'Compte des identifiants HTTPS',
  'settings.sourceControl.transport.retry': 'Recharger et réessayer',
  'settings.sourceControl.transport.unverifiedConfirmation': 'Je comprends que Git système utilise les identifiants de l’hôte Git connecté. OpenChamber ne peut pas vérifier à quel compte ils appartiennent.',
  'settings.sourceControl.transport.info': 'Associez un dépôt distant à Git système ou à un identifiant géré par l’hôte. Les comptes d’API des fournisseurs restent distincts.',
  ...
  'settings.sourceControl.transport.anonymous': 'HTTPS anonyme, lecture seule',
  'settings.sourceControl.transport.https': 'HTTPS géré',
  'settings.sourceControl.transport.ssh': 'Clé SSH gérée',
  'settings.sourceControl.transport.bind': 'Associer le dépôt',
  'settings.sourceControl.transport.noRepository': 'Ouvrez un dépôt Git pour configurer son transport.',
  'settings.sourceControl.transport.loading': 'Chargement du transport du dépôt…',
  'settings.sourceControl.transport.missing': 'Choisissez un dépôt distant et un transport pour associer ce dépôt.',
  'settings.sourceControl.transport.needsAttention': 'La configuration Git a changé. Vérifiez puis enregistrez de nouveau l’association de transport.',
  'settings.sourceControl.transport.configured': 'Le dépôt distant sélectionné possède une association de transport Git explicite.',
  'settings.sourceControl.transport.remove': 'Supprimer l’autorisation de transport',
  'settings.sourceControl.reset.title': 'Réinitialiser la configuration de gestion de code',
  'settings.sourceControl.reset.description': 'Supprimez toutes les références de gestion de code enregistrées pour ce dépôt.',
  'settings.sourceControl.reset.action': 'Réinitialiser la gestion de code',
  'settings.sourceControl.reset.confirmTitle': 'Réinitialiser la configuration de gestion de code ?',
  'settings.sourceControl.reset.confirmDescription': 'Cette action supprime toutes les références de fournisseur, de transport et auxiliaires enregistrées pour ce dépôt. Les identifiants, les dépôts distants et la configuration Git, l’arbre de travail et l’identité de l’auteur ne sont pas modifiés.',
  'settings.sourceControl.reset.failed': 'La configuration de gestion de code a changé ou n’a pas pu être réinitialisée. Vérifiez la configuration actualisée avant de réessayer.',
  'settings.sourceControl.reset.confirmAction': 'Réinitialiser la configuration',
