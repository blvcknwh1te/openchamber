...
export const settingsDict = {
  ...
  'settings.openchamber.customCss.section': 'CSS personnalisé',
  'settings.openchamber.customCss.sectionInfo': 'CSS au niveau utilisateur que l\'environnement VS Code injecte dans chaque panneau, après le thème.',
  'settings.openchamber.customCss.field.label': 'Fichier CSS',
  'settings.openchamber.customCss.field.infoWithPath': 'Les modifications s\'appliquent immédiatement. Fichier : {path}',
  'settings.openchamber.customCss.field.info': 'Les modifications s\'appliquent immédiatement. Le fichier se trouve dans votre dossier de configuration OpenChamber.',
  'settings.openchamber.customCss.actions.open': 'Ouvrir / créer',
  'settings.openchamber.customCss.actions.reset': 'Réinitialiser par défaut',
  'settings.openchamber.customCss.resetDone': 'custom.css a été réinitialisé au modèle par défaut',
  'settings.openchamber.customCss.failed': 'Impossible de mettre à jour custom.css',
  ...
  'settings.openchamber.visual.field.unifiedSlashEntitiesAria': 'Afficher les commandes et skills dans une seule liste',
  'settings.openchamber.visual.field.unifiedSlashEntities': 'Commandes et skills unifiés',
  'settings.openchamber.visual.field.unifiedSlashEntitiesInfo': 'Affiche les /commandes et /skills dans une seule liste et transmet le chemin de leur fichier à l’agent, afin qu’il voie ce que vous mentionnez à côté de votre texte. Désactivé : comportement précédent.',
