...
export const settingsDict = {
  'settings.sourceControl.ssh.title': 'Zarządzane poświadczenia SSH',
  'settings.sourceControl.ssh.load': 'Wczytaj klucze serwera',
  'settings.sourceControl.ssh.discover': 'Wyszukaj klucze hosta',
  'settings.sourceControl.ssh.empty': 'Na tym serwerze nie skonfigurowano zarządzanych kluczy SSH.',
  'settings.sourceControl.ssh.hostSetup': 'Wyszukiwanie sprawdza tylko pliki kluczy prywatnych znajdujące się bezpośrednio w katalogu ~/.ssh użytkownika połączonego serwera. Nie sprawdza podkatalogów, dowiązań symbolicznych, konfiguracji SSH ani agentów. Zaimportowane kopie pozostają w katalogu danych serwera. W przypadku kluczy chronionych hasłem lub dostępnych tylko przez agenta wybierz jawnie transport systemowy; jego poświadczenia są niezweryfikowane.',
  'settings.sourceControl.ssh.unreadable': 'Nie można odczytać klucza na serwerze. Napraw konfigurację hosta lub wybierz System.',
  'settings.sourceControl.ssh.changed': 'Odcisk klucza zmienił się. Napraw konfigurację hosta lub wybierz System.',
  'settings.sourceControl.ssh.unverifiable': 'Klucz jest zaszyfrowany lub nie można go zweryfikować. Napraw konfigurację hosta lub wybierz System.',
  'settings.sourceControl.ssh.insecurePermissions': 'Uprawnienia klucza zezwalają na dostęp innym użytkownikom. Ogranicz uprawnienia pliku na hoście przed importem.',
  'settings.sourceControl.ssh.discoveredEmpty': 'W zatwierdzonym katalogu serwera nie znaleziono kluczy prywatnych możliwych do zaimportowania.',
  'settings.sourceControl.ssh.discoveryTruncated': 'Katalog zawiera więcej wpisów niż limit wyszukiwania. Niektóre pliki nie zostały sprawdzone.',
  'settings.sourceControl.ssh.confirmFingerprint': 'Potwierdzam ten odcisk: {fingerprint}',
  'settings.sourceControl.ssh.import': 'Importuj klucz',
  'settings.sourceControl.ssh.imported': 'Klucz skopiowano do zarządzanego magazynu serwera. Nie zmieniono powiązania repozytorium.',
  'settings.sourceControl.ssh.candidateExpired': 'Ten wynik wyszukiwania wygasł. Ponownie wyszukaj klucze hosta.',
  'settings.sourceControl.ssh.candidateChanged': 'Klucz hosta zmienił się po wyszukiwaniu. Wyszukaj go ponownie przed importem.',
  'settings.sourceControl.ssh.confirmationMismatch': 'Potwierdzony odcisk nie pasuje do tego wyniku wyszukiwania.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.gitlab.info': 'Połącz GitLab.com lub własną instancję GitLab, aby obsługiwać merge requesty, zgłoszenia i CI.',
  'settings.gitlab.instance.customLabel': 'Instancja GitLab',
  'settings.gitlab.instance.customInfo': 'Użyj adresu HTTPS. HTTP jest dozwolone tylko dla adresów lokalnych.',
  'settings.gitlab.actions.useInstance': 'Użyj instancji',
  'settings.gitlab.status.checking': 'Sprawdzanie połączenia…',
  'settings.gitlab.status.operationFailed': 'Operacja nie powiodła się',
  'settings.gitlab.status.notConnected': 'Nie połączono',
  'settings.gitlab.status.connected': 'Połączono',
  'settings.gitlab.actions.connect': 'Połącz GitLab',
  'settings.gitlab.token.label': 'Osobisty token dostępu',
  'settings.gitlab.token.info': 'Token jest przechowywany przez serwer OpenChamber i nigdy nie wraca do interfejsu.',
  'settings.gitlab.device.label': 'Kod urządzenia',
  'settings.gitlab.cli.label': 'glab CLI',
  'settings.gitlab.cli.info': 'Użyj danych logowania glab, gdy żadne zapisane konto nie jest aktywne.',
  'settings.gitlab.actions.enableCli': 'Włącz glab',
  'settings.gitlab.actions.disableCli': 'Wyłącz glab',
  'settings.gitlab.instances.title': 'Instancje',
  'settings.gitlab.actions.addInstance': 'Dodaj instancję',
  'settings.gitlab.device.waiting': 'Autoryzuj urządzenie w GitLab, a następnie wróć do OpenChamber. Ta strona zaktualizuje się automatycznie.',
  'settings.gitlab.actions.openGitLab': 'Otwórz GitLab',
  'settings.sourceControl.accounts.available': 'Dostępne',
  'settings.sourceControl.accounts.configured': 'Skonfigurowane konta',
  'settings.sourceControl.accounts.connectedCount': 'Kont: {count}',
  'settings.sourceControl.accounts.needsAuthentication': 'Wymaga uwierzytelnienia',
  'settings.sourceControl.actions.reauthenticate': 'Uwierzytelnij ponownie',
  'settings.sourceControl.actions.remove': 'Usuń',
  'settings.sourceControl.binding.accountLabel': 'Konto kontroli źródła',
  'settings.sourceControl.binding.accountAriaLabel': 'Konto kontroli źródła dla aktywnego repozytorium',
  'settings.sourceControl.binding.noAccounts': 'Brak pasujących kont',
  'settings.sourceControl.binding.noRepository': 'Otwórz repozytorium Git, aby skonfigurować jego konto kontroli źródła.',
  'settings.sourceControl.binding.loading': 'Wczytywanie powiązania repozytorium…',
  'settings.sourceControl.binding.suggested': 'Potwierdź sugerowane konto, zanim OpenChamber użyje go dla tego repozytorium.',
  'settings.sourceControl.binding.configured': 'To konto jest używane do operacji API kontroli źródła w aktywnym repozytorium.',
  'settings.sourceControl.binding.confirm': 'Potwierdź konto',
  'settings.sourceControl.transport.credentialAccount': 'Konto poświadczeń HTTPS',
  'settings.sourceControl.transport.retry': 'Wczytaj ponownie i spróbuj jeszcze raz',
  'settings.sourceControl.transport.unverifiedConfirmation': 'Rozumiem, że systemowy Git używa poświadczeń na połączonym hoście Git. OpenChamber nie może zweryfikować, do którego konta należą.',
  'settings.sourceControl.transport.info': 'Powiąż zdalne repozytorium z systemowym Git lub poświadczeniami zarządzanymi przez hosta. Konta API dostawców pozostają oddzielne.',
  'settings.sourceControl.transport.remoteLabel': 'Repozytorium zdalne',
  'settings.sourceControl.transport.remoteAriaLabel': 'Repozytorium Git do skonfigurowania',
  'settings.sourceControl.transport.noRemotes': 'Brak repozytoriów zdalnych Git',
  'settings.sourceControl.transport.modeLabel': 'Poświadczenia',
  'settings.sourceControl.transport.modeAriaLabel': 'Transport Git dla wybranego repozytorium zdalnego',
  'settings.sourceControl.transport.choose': 'Wybierz transport',
  'settings.sourceControl.transport.system': 'Systemowy Git',
  'settings.sourceControl.transport.anonymous': 'Anonimowy HTTPS, tylko odczyt',
  'settings.sourceControl.transport.https': 'Zarządzany HTTPS',
  'settings.sourceControl.transport.ssh': 'Zarządzany klucz SSH',
  'settings.sourceControl.transport.bind': 'Powiąż repozytorium',
  'settings.sourceControl.transport.noRepository': 'Otwórz repozytorium Git, aby skonfigurować jego transport.',
  'settings.sourceControl.transport.loading': 'Wczytywanie transportu repozytorium…',
  'settings.sourceControl.transport.missing': 'Wybierz repozytorium zdalne i transport, aby powiązać to repozytorium.',
  'settings.sourceControl.transport.needsAttention': 'Konfiguracja Git uległa zmianie. Sprawdź i ponownie zapisz powiązanie transportu.',
  'settings.sourceControl.transport.configured': 'Wybrane repozytorium zdalne ma jawne powiązanie transportu Git.',
  'settings.sourceControl.transport.remove': 'Usuń uprawnienie transportu',
  'settings.sourceControl.reset.title': 'Zresetuj konfigurację kontroli źródła',
  'settings.sourceControl.reset.description': 'Usuń wszystkie zapisane odwołania kontroli źródła dla tego repozytorium.',
  'settings.sourceControl.reset.action': 'Zresetuj kontrolę źródła',
  'settings.sourceControl.reset.confirmTitle': 'Zresetować konfigurację kontroli źródła?',
  'settings.sourceControl.reset.confirmDescription': 'Spowoduje to usunięcie wszystkich zapisanych odwołań do dostawców, transportu i zasobów pomocniczych dla tego repozytorium. Poświadczenia, zdalne repozytoria i konfiguracja Git, drzewo robocze oraz tożsamość autora pozostaną bez zmian.',
  'settings.sourceControl.reset.failed': 'Konfiguracja kontroli źródła zmieniła się lub nie udało się jej zresetować. Sprawdź odświeżoną konfigurację przed ponowną próbą.',
  'settings.sourceControl.reset.confirmAction': 'Zresetuj konfigurację',
