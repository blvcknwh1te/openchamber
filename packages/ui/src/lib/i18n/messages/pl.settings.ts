...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.unifiedSlashEntitiesAria': 'Pokazuj polecenia i skille na jednej liście',
  'settings.openchamber.visual.field.unifiedSlashEntities': 'Ujednolicone polecenia i skille',
  'settings.openchamber.visual.field.unifiedSlashEntitiesInfo': 'Pokazuje /polecenia i /skille na jednej liście i przekazuje agentowi ścieżkę do ich pliku, aby widział, do czego odnosisz się obok swojego tekstu. Wyłączone: poprzednie zachowanie.',
  ...
  'settings.openchamber.customCss.section': 'Niestandardowy CSS',
  'settings.openchamber.customCss.sectionInfo': 'CSS na poziomie użytkownika, który środowisko VS Code wstrzykuje do każdego panelu, po motywie.',
  'settings.openchamber.customCss.field.label': 'Plik CSS',
  'settings.openchamber.customCss.field.infoWithPath': 'Zmiany działają od razu. Plik: {path}',
  'settings.openchamber.customCss.field.info': 'Zmiany działają od razu. Plik znajduje się w folderze konfiguracji OpenChamber.',
  'settings.openchamber.customCss.actions.open': 'Otwórz / utwórz',
  'settings.openchamber.customCss.actions.reset': 'Przywróć domyślne',
  'settings.openchamber.customCss.resetDone': 'custom.css przywrócono do domyślnego szablonu',
  'settings.openchamber.customCss.failed': 'Nie udało się zaktualizować custom.css',
