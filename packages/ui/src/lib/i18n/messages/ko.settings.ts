...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.projects.shared.badge': '공유됨',
  ...
  'settings.projects.shared.title': '공유 설정',
  'settings.projects.shared.description': '이 프로젝트가 저장소의 파일을 통해 팀과 공유하는 설정입니다. 항목을 공유하기 전에는 아무것도 기록되지 않습니다.',
  ...
  'settings.projects.shared.plansDir': '공유 플랜 폴더',
  'settings.projects.shared.plansDirPlaceholder': '예: docs/plans',
  'settings.projects.shared.plansDirInfo': '저장소 안의 폴더입니다. 이 폴더의 플랜은 팀과 공유되고 플랜 탭에 표시됩니다. 플랜을 개인용으로 유지하려면 비워 두세요.',
  'settings.projects.shared.plansDirAria': '공유 플랜 폴더',
  'settings.projects.shared.actions.share': '팀과 공유',
  'settings.projects.shared.actions.makePersonal': '개인용으로 전환',
  ...
  'settings.projects.shared.replaceMode': '내 설정 명령만 사용',
  'settings.projects.shared.replaceModeAria': '내 설정 명령만 사용하고 팀의 명령은 건너뛰기',
  'settings.projects.shared.toast.shareFailed': '공유 설정을 업데이트하지 못했습니다',
