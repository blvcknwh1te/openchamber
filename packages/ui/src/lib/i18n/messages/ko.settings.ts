...
export const settingsDict = {
  'settings.sourceControl.ssh.title': '관리형 SSH 인증 정보',
  'settings.sourceControl.ssh.load': '서버 키 불러오기',
  'settings.sourceControl.ssh.discover': '호스트 키 검색',
  'settings.sourceControl.ssh.empty': '이 서버에 구성된 관리형 SSH 키가 없습니다.',
  'settings.sourceControl.ssh.hostSetup': '검색은 연결된 서버 사용자 계정의 ~/.ssh 디렉터리에 바로 있는 개인 키 파일만 확인합니다. 하위 디렉터리, 심볼릭 링크, SSH 설정 또는 에이전트는 검사하지 않습니다. 가져온 복사본은 서버 데이터 디렉터리에 보관됩니다. 암호로 보호되거나 에이전트에만 있는 키는 시스템 전송을 명시적으로 선택하세요. 해당 인증 정보는 검증되지 않습니다.',
  'settings.sourceControl.ssh.unreadable': '서버에서 키를 읽을 수 없습니다. 호스트 설정을 수정하거나 시스템을 선택하세요.',
  'settings.sourceControl.ssh.changed': '키 지문이 변경되었습니다. 호스트 설정을 수정하거나 시스템을 선택하세요.',
  'settings.sourceControl.ssh.unverifiable': '키가 암호화되어 있거나 검증할 수 없습니다. 호스트 설정을 수정하거나 시스템을 선택하세요.',
  'settings.sourceControl.ssh.insecurePermissions': '키 권한이 다른 사용자의 접근을 허용합니다. 가져오기 전에 호스트 파일의 권한을 제한하세요.',
  'settings.sourceControl.ssh.discoveredEmpty': '승인된 서버 디렉터리에서 가져올 수 있는 개인 키를 찾지 못했습니다.',
  'settings.sourceControl.ssh.discoveryTruncated': '디렉터리 항목 수가 검색 제한을 초과합니다. 일부 파일은 검사하지 않았습니다.',
  'settings.sourceControl.ssh.confirmFingerprint': '이 지문을 확인했습니다: {fingerprint}',
  'settings.sourceControl.ssh.import': '키 가져오기',
  'settings.sourceControl.ssh.imported': '키를 관리형 서버 저장소에 복사했습니다. 저장소 바인딩은 변경하지 않았습니다.',
  'settings.sourceControl.ssh.candidateExpired': '이 검색 결과가 만료되었습니다. 호스트 키를 다시 검색하세요.',
  'settings.sourceControl.ssh.candidateChanged': '검색 후 호스트 키가 변경되었습니다. 가져오기 전에 다시 검색하세요.',
  'settings.sourceControl.ssh.confirmationMismatch': '확인한 지문이 이 검색 결과와 일치하지 않습니다.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.gitlab.info': '병합 요청, 이슈 및 CI를 위해 GitLab.com 또는 자체 관리 GitLab 인스턴스를 연결합니다.',
  'settings.gitlab.instance.customLabel': 'GitLab 인스턴스',
  'settings.gitlab.instance.customInfo': 'HTTPS 주소를 사용하세요. HTTP는 로컬 주소에서만 허용됩니다.',
  ...
  'settings.gitlab.device.label': '기기 코드',
  'settings.gitlab.cli.label': 'glab CLI',
  'settings.gitlab.cli.info': '활성 저장 계정이 없을 때 glab 자격 증명을 사용합니다.',
  'settings.gitlab.actions.enableCli': 'glab 활성화',
  'settings.gitlab.actions.disableCli': 'glab 비활성화',
  'settings.gitlab.instances.title': '인스턴스',
  ...
  'settings.sourceControl.binding.accountLabel': '소스 제어 계정',
  'settings.sourceControl.binding.accountAriaLabel': '활성 저장소의 소스 제어 계정',
  'settings.sourceControl.binding.noAccounts': '일치하는 계정 없음',
  'settings.sourceControl.binding.noRepository': 'Git 저장소를 열어 소스 제어 계정을 구성하세요.',
  'settings.sourceControl.binding.loading': '저장소 연결을 불러오는 중…',
  'settings.sourceControl.binding.suggested': 'OpenChamber가 이 저장소에서 사용하기 전에 제안된 계정을 확인하세요.',
  'settings.sourceControl.binding.configured': '이 계정은 활성 저장소의 소스 제어 API 작업에 사용됩니다.',
  'settings.sourceControl.binding.confirm': '계정 확인',
  'settings.sourceControl.transport.credentialAccount': 'HTTPS 인증 정보 계정',
  'settings.sourceControl.transport.retry': '새로고침 후 다시 시도',
  'settings.sourceControl.transport.unverifiedConfirmation': '시스템 Git이 연결된 Git 호스트의 인증 정보를 사용한다는 점을 이해합니다. OpenChamber는 해당 인증 정보가 어느 계정에 속하는지 확인할 수 없습니다.',
  'settings.sourceControl.transport.info': '저장소 원격을 시스템 Git 또는 호스트에서 관리하는 자격 증명에 연결합니다. 공급자 API 계정은 별도로 유지됩니다.',
  ...
  'settings.sourceControl.transport.anonymous': '익명 HTTPS, 읽기 전용',
  'settings.sourceControl.transport.https': '관리형 HTTPS',
  'settings.sourceControl.transport.ssh': '관리형 SSH 키',
  'settings.sourceControl.transport.bind': '저장소 연결',
  'settings.sourceControl.transport.noRepository': 'Git 저장소를 열어 전송을 구성하세요.',
  'settings.sourceControl.transport.loading': '저장소 전송을 불러오는 중…',
  'settings.sourceControl.transport.missing': '이 저장소를 연결할 원격과 전송을 선택하세요.',
  'settings.sourceControl.transport.needsAttention': 'Git 구성이 변경되었습니다. 전송 바인딩을 검토하고 다시 저장하세요.',
  'settings.sourceControl.transport.configured': '선택한 원격에 명시적인 Git 전송 바인딩이 있습니다.',
  'settings.sourceControl.transport.remove': '전송 권한 제거',
  'settings.sourceControl.reset.title': '소스 제어 설정 초기화',
  'settings.sourceControl.reset.description': '이 저장소에 저장된 모든 소스 제어 참조를 제거합니다.',
  'settings.sourceControl.reset.action': '소스 제어 설정 초기화',
  'settings.sourceControl.reset.confirmTitle': '소스 제어 설정을 초기화할까요?',
  'settings.sourceControl.reset.confirmDescription': '이 저장소에 저장된 공급자, 전송 및 보조 참조가 모두 제거됩니다. 자격 증명, Git 원격 및 구성, 작업 트리와 작성자 ID는 변경되지 않습니다.',
  'settings.sourceControl.reset.failed': '소스 제어 설정이 변경되었거나 초기화하지 못했습니다. 다시 시도하기 전에 새로 고친 설정을 확인하세요.',
  'settings.sourceControl.reset.confirmAction': '설정 초기화',
