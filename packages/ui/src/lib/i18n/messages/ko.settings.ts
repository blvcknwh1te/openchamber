...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.customCss.section': '사용자 정의 CSS',
  'settings.openchamber.customCss.sectionInfo': 'VS Code 런타임이 테마 다음에 모든 패널에 삽입하는 사용자 수준 CSS입니다.',
  'settings.openchamber.customCss.field.label': 'CSS 파일',
  'settings.openchamber.customCss.field.infoWithPath': '편집 내용이 즉시 적용됩니다. 파일: {path}',
  'settings.openchamber.customCss.field.info': '편집 내용이 즉시 적용됩니다. 파일은 OpenChamber 설정 폴더에 있습니다.',
  'settings.openchamber.customCss.actions.open': '열기 / 만들기',
  'settings.openchamber.customCss.actions.reset': '기본값으로 초기화',
  'settings.openchamber.customCss.resetDone': 'custom.css를 기본 템플릿으로 초기화했습니다',
  'settings.openchamber.customCss.failed': 'custom.css를 업데이트할 수 없습니다',
  ...
  'settings.openchamber.visual.field.unifiedSlashEntitiesAria': '명령과 스킬을 하나의 슬래시 목록에 표시',
  'settings.openchamber.visual.field.unifiedSlashEntities': '슬래시 명령 및 스킬 통합',
  'settings.openchamber.visual.field.unifiedSlashEntitiesInfo': '/명령과 /스킬을 하나의 목록에 표시하고 에이전트에 해당 파일 경로를 전달하여, 텍스트 옆에서 무엇을 참조하는지 에이전트가 파악할 수 있게 합니다. 끄기: 이전 동작.',
