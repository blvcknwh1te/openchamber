...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.projects.shared.title': '共享設定',
  'settings.projects.shared.description': '此專案透過儲存庫中的檔案與團隊共享的設定。在你共享某個項目之前不會寫入任何內容。',
  'settings.projects.shared.file': '檔案',
  'settings.projects.shared.status.missing': '尚未在儲存庫中',
  'settings.projects.shared.status.ok': '已在儲存庫中',
  'settings.projects.shared.plansDir': '共享計畫資料夾',
  'settings.projects.shared.plansDirPlaceholder': '例如 docs/plans',
  'settings.projects.shared.plansDirInfo': '儲存庫內的資料夾。其中的計畫與團隊共享並顯示在「計畫」分頁；留空則計畫維持為個人。',
  'settings.projects.shared.plansDirAria': '共享計畫資料夾',
  'settings.projects.shared.actions.share': '與團隊共享',
  'settings.projects.shared.actions.makePersonal': '設為個人',
  ...
  'settings.projects.shared.replaceMode': '僅使用我的設定命令',
  'settings.projects.shared.replaceModeAria': '僅使用我的設定命令，略過團隊的命令',
  'settings.projects.shared.toast.shareFailed': '更新共享設定失敗',
