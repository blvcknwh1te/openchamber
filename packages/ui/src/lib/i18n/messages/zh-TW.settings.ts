...
export const settingsDict = {
  'settings.sourceControl.ssh.title': '受管理的 SSH 憑證',
  'settings.sourceControl.ssh.load': '載入伺服器金鑰',
  'settings.sourceControl.ssh.discover': '尋找主機金鑰',
  'settings.sourceControl.ssh.empty': '此伺服器尚未設定受管理的 SSH 金鑰。',
  'settings.sourceControl.ssh.hostSetup': '搜尋只會檢查已連線伺服器使用者的 ~/.ssh 目錄中直接包含的私密金鑰檔案，不會檢查子目錄、符號連結、SSH 設定或代理程式。匯入的副本會保留在伺服器資料目錄中。若使用受密碼保護或僅存在於代理程式中的金鑰，請明確選擇系統傳輸；其憑證未經驗證。',
  'settings.sourceControl.ssh.unreadable': '伺服器無法讀取金鑰。請修正主機設定或選擇系統傳輸。',
  'settings.sourceControl.ssh.changed': '金鑰指紋已變更。請修正主機設定或選擇系統傳輸。',
  'settings.sourceControl.ssh.unverifiable': '金鑰已加密或無法驗證。請修正主機設定或選擇系統傳輸。',
  'settings.sourceControl.ssh.insecurePermissions': '金鑰權限允許其他使用者存取。請在匯入前限制主機檔案的權限。',
  'settings.sourceControl.ssh.discoveredEmpty': '在核准的伺服器目錄中找不到可匯入的私密金鑰。',
  'settings.sourceControl.ssh.discoveryTruncated': '目錄項目數超過搜尋上限，部分檔案未經檢查。',
  'settings.sourceControl.ssh.confirmFingerprint': '我已核對此指紋：{fingerprint}',
  'settings.sourceControl.ssh.import': '匯入金鑰',
  'settings.sourceControl.ssh.imported': '金鑰已複製到伺服器的受管理儲存區。未變更任何儲存庫繫結。',
  'settings.sourceControl.ssh.candidateExpired': '此搜尋結果已過期。請重新搜尋主機金鑰。',
  'settings.sourceControl.ssh.candidateChanged': '主機金鑰在搜尋後發生變更。請在匯入前重新搜尋。',
  'settings.sourceControl.ssh.confirmationMismatch': '確認的指紋與此搜尋結果不符。',
  'settings.sourceControl.ssh.candidateUnavailable': '主機金鑰已無法匯入。請重新搜尋主機金鑰。',
  'settings.sourceControl.ssh.inventoryFull': '受管理的 SSH 金鑰儲存區已達上限。請先移除未使用的金鑰再匯入其他金鑰。',
  'settings.sourceControl.ssh.operationFailed': '受管理的 SSH 請求失敗。請重試此操作。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.gitlab.info': '連線 GitLab.com 或自行管理的 GitLab 執行個體，以使用合併請求、議題與 CI。',
  'settings.gitlab.instance.customLabel': 'GitLab 執行個體',
  'settings.gitlab.instance.customInfo': '請使用 HTTPS 來源。只有本機位址可使用 HTTP。',
  ...
  'settings.gitlab.device.label': '裝置代碼',
  'settings.gitlab.cli.label': 'glab CLI',
  'settings.gitlab.cli.info': '沒有使用中的已儲存帳戶時，使用 glab 認證。',
  'settings.gitlab.actions.enableCli': '啟用 glab',
  'settings.gitlab.actions.disableCli': '停用 glab',
  'settings.gitlab.instances.title': '執行個體',
  ...
  'settings.sourceControl.binding.accountLabel': '原始碼管理帳戶',
  'settings.sourceControl.binding.accountAriaLabel': '目前儲存庫的原始碼管理帳戶',
  'settings.sourceControl.binding.noAccounts': '沒有相符的帳戶',
  'settings.sourceControl.binding.noRepository': '開啟 Git 儲存庫以設定其原始碼管理帳戶。',
  'settings.sourceControl.binding.loading': '正在載入儲存庫綁定…',
  'settings.sourceControl.binding.suggested': '請先確認建議的帳戶，OpenChamber 才會將其用於此儲存庫。',
  'settings.sourceControl.binding.configured': '此帳戶用於目前儲存庫中的原始碼管理 API 操作。',
  'settings.sourceControl.binding.confirm': '確認帳戶',
  'settings.sourceControl.transport.credentialAccount': 'HTTPS 憑證帳號',
  'settings.sourceControl.transport.retry': '重新載入並重試',
  'settings.sourceControl.transport.unverifiedConfirmation': '我了解系統 Git 會使用已連線 Git 主機上的憑證。OpenChamber 無法驗證這些憑證屬於哪個帳號。',
  'settings.sourceControl.transport.info': '將儲存庫遠端綁定至系統 Git 或由主機管理的認證。提供者 API 帳戶保持分開。',
  ...
  'settings.sourceControl.transport.anonymous': '匿名 HTTPS，唯讀',
  'settings.sourceControl.transport.https': '受管理的 HTTPS',
  'settings.sourceControl.transport.ssh': '受管理的 SSH 金鑰',
  'settings.sourceControl.transport.bind': '綁定儲存庫',
  'settings.sourceControl.transport.noRepository': '開啟 Git 儲存庫以設定其傳輸方式。',
  'settings.sourceControl.transport.loading': '正在載入儲存庫傳輸設定…',
  'settings.sourceControl.transport.missing': '選擇遠端和傳輸方式以綁定此儲存庫。',
  'settings.sourceControl.transport.needsAttention': 'Git 設定已變更。請檢查並重新儲存傳輸綁定。',
  'settings.sourceControl.transport.configured': '所選遠端具有明確的 Git 傳輸綁定。',
  'settings.sourceControl.transport.remove': '移除傳輸授權',
  'settings.sourceControl.reset.title': '重設原始碼管理設定',
  'settings.sourceControl.reset.description': '移除此儲存庫已儲存的所有原始碼管理參照。',
  'settings.sourceControl.reset.action': '重設原始碼管理設定',
  'settings.sourceControl.reset.confirmTitle': '重設原始碼管理設定？',
  'settings.sourceControl.reset.confirmDescription': '這會移除此儲存庫已儲存的所有供應商、傳輸及輔助參照。憑證、Git 遠端與設定、工作樹以及作者身分都不會變更。',
  'settings.sourceControl.reset.failed': '原始碼管理設定已變更或無法重設。請先檢查重新整理後的設定，再重試。',
  'settings.sourceControl.reset.confirmAction': '重設設定',
