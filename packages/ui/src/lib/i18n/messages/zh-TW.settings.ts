...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.customCss.section': '自訂 CSS',
  'settings.openchamber.customCss.sectionInfo': 'VS Code 執行階段在主題之後注入每個面板的使用者層級 CSS。',
  'settings.openchamber.customCss.field.label': 'CSS 檔案',
  'settings.openchamber.customCss.field.infoWithPath': '變更會立即生效。檔案：{path}',
  'settings.openchamber.customCss.field.info': '變更會立即生效。該檔案位於 OpenChamber 設定資料夾中。',
  'settings.openchamber.customCss.actions.open': '開啟 / 建立',
  'settings.openchamber.customCss.actions.reset': '還原預設值',
  'settings.openchamber.customCss.resetDone': 'custom.css 已還原為預設範本',
  'settings.openchamber.customCss.failed': '無法更新 custom.css',
  ...
  'settings.openchamber.visual.field.unifiedSlashEntitiesAria': '在同一斜線列表中顯示命令與技能',
  'settings.openchamber.visual.field.unifiedSlashEntities': '統一的斜線命令與技能',
  'settings.openchamber.visual.field.unifiedSlashEntitiesInfo': '將 /命令與 /技能顯示在同一列表中，並把其檔案路徑傳給智能體，讓它能看見你在文字旁邊引用的內容。關閉：沿用舊行為。',
