...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.tooltip.model': 'Model: {model}',
  'sessions.sidebar.session.tooltip.cost': 'Koszt: {cost}',
  'sessions.sidebar.session.tooltip.tokens': 'Tokeny: {tokens}',
  ...
  'chat.compaction.tooltip.automatic': 'Kompresja kontekstu uruchomiła się automatycznie',
  'chat.compaction.tooltip.manual': 'Kompresja kontekstu uruchomiona poleceniem /compact',
  'chat.compaction.tooltip.overflow': 'Okno kontekstu było pełne',
  'chat.compaction.tooltip.tokens': 'Kontekst: {before} → {after} tokenów',
  'chat.compaction.tooltip.tokensShare': '{percent}% limitu kontekstu',
  'chat.compaction.tooltip.tokensBefore': 'Kontekst przed: {tokens} tokenów',
  'chat.compaction.tooltip.tokensAfter': 'Kontekst po: {tokens} tokenów',
  'chat.compaction.tooltip.viewSummary': 'Kliknij, aby zobaczyć podsumowanie, które zastąpiło wcześniejsze wiadomości',
  'chat.compaction.tooltip.effect': 'Podsumowanie zastępuje wcześniejsze wiadomości w kontekście modelu.',
  'chat.compaction.tooltip.time': 'Skompresowano {time}',
  ...
  'chat.toolPart.openSubtaskDialog': 'Otwórz podzadanie w oknie dialogowym',
