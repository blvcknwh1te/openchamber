...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.context.ariaLabel': 'Kontekst operacji kontroli źródła',
  ...
  'gitView.context.ready': 'Gotowe',
  'gitView.context.needsAttention': 'Wymaga uwagi',
  'gitView.context.readiness.confirmationRequired': 'Wymaga potwierdzenia przed użyciem',
  'gitView.context.readiness.accountUnavailable': 'Powiązane konto nie jest już dostępne',
  ...
  'gitView.context.stale': 'Ostatni zapisany kontekst, oczekuje na weryfikację',
  'gitView.context.provider': 'Dostawca',
  'gitView.context.author': 'Autor',
  'gitView.context.notConfigured': 'Nie skonfigurowano',
